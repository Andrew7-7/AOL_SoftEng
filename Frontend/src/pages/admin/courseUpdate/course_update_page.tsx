...
const CourseUpdatePage = () => {
	...
	const resetForm = () => {
		setCourseFormData({
			...
			totalSession: courseData.Sessions.toString(),
			hourPerSession: courseData.totalHours,
			chapterBreakdowns: courseData.chapterBreakdown,
			courseImage: courseData.CourseImage,
		});
		setPreviewUrl(courseData.CourseImage);
	};
