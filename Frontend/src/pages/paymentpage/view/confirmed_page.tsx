      ...
      <div className='loading-bar-modal'>
        ...
        <div className='loading-bar-progress-container'>
          <div className='loading-bar-progress-modal-not-completed'>
            <div className='loading-bar-progress-modal-completed'
              style={{
                width: `${progress}%`
              }}
            />
        ...
        <div className='loading-bar-modal-h5'>After this you will be automatically directed to material page</div>
      </div>
    </>
  )
}
